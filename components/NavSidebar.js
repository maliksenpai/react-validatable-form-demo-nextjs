        ...
        subNav: [
            {
                ...
                itemId: '/library-api/react-validatable-form-provider',
                keywords: [
                    'lang',
                    'customRules',
                    'translations',
            ...
            },
            {
                ...
                itemId: '/library-api/use-validatable-form',
                keywords: [
                    'rules',
                    'initialFormData',
                    'hideBeforeSubmit',
...
export const NavSidebar = ({ menuIsHidden, toggleDrawer }) => {
    ...
    useEffect(() => {
        setSearchInput('');
        if (router.pathname.includes('/getting-started/')) {
            setExpanded('group1');
        } else if (router.pathname.includes('/rules/')) {
            setExpanded('group2');
        } else if (router.pathname.includes('/advanced/')) {
            setExpanded('group3');
        } else if (router.pathname.includes('/customizations/')) {
            setExpanded('group4');
        } else if (router.pathname.includes('/examples/')) {
            setExpanded('group5');
        } else if (router.pathname.includes('/library-api/')) {
            setExpanded('group6');
        }
    }, [router]);
                ...
                <AccordionDetails>
                    <List disablePadding>
                        {fm.subNav.map((sn) => {
                            return (
                                <div
                                    className={router.pathname === sn.itemId ? 'selectedSideItem' : null}
                                    key={sn.itemId}
